  ...
  en: {
    ...
    services: {
      ...
      ml: {
        ...
        features: ["Automated Customer Support", "AI Receptionist", "Multi-language voice support", "Sales and Outreach", "AI Voice Generation"],
  ...
  fr: {
    ...
    services: {
      ...
      ml: {
        ...
        features: ["Support Client Automatisé", "Réceptionniste IA", "Support vocal multilingue", "Ventes et Prospection", "Génération de Voix IA"],
  ...
  es: {
    ...
    services: {
      ...
      ml: {
        ...
        features: ["Soporte al Cliente Automatizado", "Recepcionista IA", "Soporte de voz multilingüe", "Ventas y Alcance", "Generación de Voz IA"],
