export const translations = {
  en: {
    ...
    auth: {
      ...
      registerTitle: "Join AI Edge International",
      loginSubtitle: "Access your dashboard and manage your AI projects",
      registerSubtitle: "Start your AI transformation journey today",
      username: "Username",
      email: "Email Address",
      password: "Password",
  ...
  fr: {
    ...
    auth: {
      ...
      registerTitle: "Rejoindre AI Edge International",
      loginSubtitle: "Accédez à votre tableau de bord et gérez vos projets IA",
      registerSubtitle: "Commencez votre parcours de transformation IA aujourd'hui",
  ...
  es: {
    ...
    services: {
      ...
      automation: {
        ...
        description: "Optimiza operaciones con flujos de trabajo potenciados por IA que se adaptan y optimizan en tiempo real."
      },
      ml: {
    ...
    auth: {
      ...
      registerTitle: "Únete a AI Edge International",
      loginSubtitle: "Accede a tu panel y gestiona tus proyectos IA",
      registerSubtitle: "Comienza tu viaje de transformación IA hoy",
