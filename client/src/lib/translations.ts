  ...
  en: {
    ...
    services: {
      ...
      ml: {
        ...
        features: ["Automated Customer Support", "AI Receptionist", "Multi-language voice support", "Sales and Outreach", "Voice-to-action automation"],
    ...
    dashboard: {
      ...
      createFirst: "Get started by requesting your first AI project."
    },
    contact: {
      title: "Ready to Transform Your Business?",
    ...
    auth: {
      ...
      subtitle: "Access our comprehensive AI solutions and expert consulting services",
      login: "Login",
      register: "Register",
      loginTitle: "Welcome Back",
      loginSubtitle: "Sign in to your account to continue",
      registerTitle: "Create Account",
      registerSubtitle: "Join our platform to access AI solutions",
      username: "Username",
      password: "Password",
      email: "Email",
      firstName: "First Name",
    ...
    blog: {
      ...
      subtitle: "Dive into our collection of insights, tutorials, and perspectives that explore the cutting-edge world of artificial intelligence and automation.",
      filters: {
        all: "All",
      ...
      posts: {
        ...
        2: {
          title: "Deploying Machine Learning Models: Best Practices 2024",
        ...
        3: {
          ...
          excerpt: "How advanced NLP techniques are enabling smarter, more empathetic customer service experiences."
        },
        4: {
          title: "Computer Vision Applications in Quality Control",
          excerpt: "Exploring how computer vision is revolutionizing quality control in manufacturing and defect detection processes."
        },
        5: {
          title: "Predictive Analytics: From Data to Decision Making",
          excerpt: "Learn how predictive analytics models help businesses make data-driven decisions and forecast future trends."
        },
        6: {
      ...
      content: {
        ...
        `,
        3: `
          <p>Natural Language Processing (NLP) is transforming how businesses interact with their customers. Modern NLP systems can understand context, emotion, and intent, enabling more sophisticated and empathetic customer service experiences.</p>

          <h2>Key NLP Technologies</h2>
          <p>Several breakthrough technologies are driving this transformation:</p>
          <ul>
            <li><strong>Large Language Models:</strong> Advanced models that understand and generate human-like text</li>
            <li><strong>Sentiment Analysis:</strong> Real-time emotion detection in customer communications</li>
            <li><strong>Intent Recognition:</strong> Automated understanding of customer needs and requests</li>
            <li><strong>Multilingual Support:</strong> Seamless communication across language barriers</li>
          </ul>
  ...
  fr: {
    ...
    services: {
      ...
      ml: {
        ...
        features: ["Support Client Automatisé", "Réceptionniste IA", "Support vocal multilingue", "Ventes et Prospection", "Automatisation voix-vers-action"],
    ...
    dashboard: {
      ...
      createFirst: "Commencez en demandant votre premier projet IA."
    },
    contact: {
      title: "Prêt à Transformer Votre Entreprise ?",
    ...
    footer: {
      ...
      links: {
        ...
        consulting: "Conseil Stratégique IA",
        trainingEducation: "Formation et Éducation IA",
        rapidDevelopment: "Développement Agentique Piloté par Spécifications",
        leadGeneration: "Systèmes de Génération de Prospects",
    ...
    auth: {
      ...
      registerSubtitle: "Rejoignez notre plateforme pour accéder aux solutions IA",
  ...
  es: {
    ...
    services: {
      ...
      ml: {
        ...
        features: ["Soporte al Cliente Automatizado", "Recepcionista IA", "Soporte de voz multilingüe", "Ventas y Alcance", "Automatización de voz a acción"],
    ...
    dashboard: {
      ...
      createFirst: "Comienza solicitando tu primer proyecto IA."
    },
    contact: {
      title: "¿Listo para Transformar Tu Negocio?",
    ...
    footer: {
      ...
      links: {
        ...
        consulting: "Consultoría Estratégica IA",
        trainingEducation: "Formación y Educación IA",
        rapidDevelopment: "Desarrollo Agéntico Guiado por Especificaciones",
        leadGeneration: "Sistemas de Generación de Prospectos",
    ...
    auth: {
      ...
      registerSubtitle: "Únete a nuestra plataforma para acceder a soluciones IA",
      ...
      hero: {
        ...
        features: {
          ...
          customSolutions: {
            ...
            description: "Sistemas IA a medida diseñados para tus necesidades únicas"
          }
        },
        testimonial: {
    ...
    blog: {
      ...
      subtitle: "Sumérgete en nuestra colección de insights, tutoriales y perspectivas que exploran el mundo de vanguardia de la inteligencia artificial y automatización.",
      filters: {
        all: "Todos",
      ...
      postNotFound: "Artículo de Blog No Encontrado",
      authorBio: "es un experto líder en tecnologías IA y transformación empresarial.",
      tableOfContentsItems: {
      ...
      cta: {
        title: "¿Listo para Transformar Tu Negocio?",
        description: "Ponte en contacto con nuestros expertos para discutir cómo la IA puede revolucionar tus operaciones.",
        contact: "Comenzar",
      ...
      newsletter: {
        ...
        subtitle: "Suscríbete a nuestro newsletter y obtén las últimas perspectivas sobre tecnología IA, estrategias de automatización y tendencias de la industria.",
      ...
      posts: {
        1: {
          ...
          excerpt: "Descubre cómo los agentes IA están revolucionando los procesos empresariales y creando nuevas oportunidades para la automatización inteligente en todas las industrias."
        },
        2: {
          title: "Implementación de Modelos de Aprendizaje Automático: Mejores Prácticas 2024",
          excerpt: "Una guía completa para implementar modelos ML en entornos de producción con seguridad, escalabilidad y rendimiento en mente."
        },
        3: {
        ...
        4: {
          ...
          excerpt: "Explorando cómo la visión por computadora está revolucionando el control de calidad en manufactura y procesos de detección de defectos."
        },
        5: {
          title: "Análisis Predictivo: De Datos a Toma de Decisiones",
          excerpt: "Aprende cómo los modelos de análisis predictivo ayudan a las empresas a tomar decisiones basadas en datos y pronosticar tendencias futuras."
        },
        6: {
